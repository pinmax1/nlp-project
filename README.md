...
2. Download models after containers are running: docker exec -it ollama ollama pull mxbai-embed-large
3. To make query: curl -X POST http://localhost:8000/process -H "Content-Type: application/json" -d "{\"text\":\"your user query\"}"
